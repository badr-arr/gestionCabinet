...
namespace Projet {
    ...
    public partial class projetDataSet : global::System.Data.DataSet {
        ...
        public partial class RDVDataTable : global::System.Data.TypedTableBase<RDVRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public RDVRow AddRDVRow(int id, Table_patientRow parentTable_patientRowByFK_RDV_Patient, string nom_patient, string prenom_patient, System.DateTime jour, string heure, string description, string statut) {
...
namespace Projet.projetDataSetTableAdapters {
    ...
    public partial class RDVTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[RDV] ([id], [id_patient], [nom_patient], [prenom_patient], [jour], [heure], [description], [statut]) VALUES (@id, @id_patient, @nom_patient, @prenom_patient, @jour, @heure, @description, @statut);
SELECT id, id_patient, nom_patient, prenom_patient, jour, heure, description, statut FROM RDV WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[RDV] SET [id] = @id, [id_patient] = @id_patient, [nom_patient] = @nom_patient, [prenom_patient] = @prenom_patient, [jour] = @jour, [heure] = @heure, [description] = @description, [statut] = @statut WHERE (([id] = @Original_id) AND ((@IsNull_id_patient = 1 AND [id_patient] IS NULL) OR ([id_patient] = @Original_id_patient)) AND ([nom_patient] = @Original_nom_patient) AND ([prenom_patient] = @Original_prenom_patient) AND ([jour] = @Original_jour) AND ([heure] = @Original_heure) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)) AND ((@IsNull_statut = 1 AND [statut] IS NULL) OR ([statut] = @Original_statut)));
SELECT id, id_patient, nom_patient, prenom_patient, jour, heure, description, statut FROM RDV WHERE (id = @id)";
        ...
        public virtual int Fill(projetDataSet.RDVDataTable dataTable) {
        ...
        public virtual projetDataSet.RDVDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            projetDataSet.RDVDataTable dataTable = new projetDataSet.RDVDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(projetDataSet.RDVDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(projetDataSet dataSet) {
        ...
        public virtual int Delete(int Original_id, global::System.Nullable<int> Original_id_patient, string Original_nom_patient, string Original_prenom_patient, System.DateTime Original_jour, string Original_heure, string Original_description, string Original_statut) {
        ...
        public virtual int Insert(int id, global::System.Nullable<int> id_patient, string nom_patient, string prenom_patient, System.DateTime jour, string heure, string description, string statut) {
        ...
        public virtual int Update(
            ...
            if ((Original_nom_patient == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_nom_patient));
            }
            if ((Original_prenom_patient == null)) {
                throw new global::System.ArgumentNullException("Original_prenom_patient");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_prenom_patient));
            }
            this.Adapter.UpdateCommand.Parameters[13].Value = ((System.DateTime)(Original_jour));
            if ((Original_heure == null)) {
                throw new global::System.ArgumentNullException("Original_heure");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[14].Value = ((string)(Original_heure));
            }
            if ((Original_description == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> id_patient, string nom_patient, string prenom_patient, System.DateTime jour, string heure, string description, string statut, int Original_id, global::System.Nullable<int> Original_id_patient, string Original_nom_patient, string Original_prenom_patient, System.DateTime Original_jour, string Original_heure, string Original_description, string Original_statut) {
            return this.Update(Original_id, id_patient, nom_patient, prenom_patient, jour, heure, description, statut, Original_id, Original_id_patient, Original_nom_patient, Original_prenom_patient, Original_jour, Original_heure, Original_description, Original_statut);
        }
    }
...
SELECT id, num_dossier, num_sante, prenom, nom, cin, email, adresse, date_naissance, lieu_naissance, tel, tel_urgence, sexe, description, groupe_sanguin, situation_familiale, assurance FROM Table_patient WHERE (id = SCOPE_IDENTITY())";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(projetDataSet.Table_patientDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual projetDataSet.Table_patientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            projetDataSet.Table_patientDataTable dataTable = new projetDataSet.Table_patientDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(projetDataSet.Table_patientDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
